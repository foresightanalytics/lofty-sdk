...
| `quantity` | `number` | yes | Number of tokens — whole shares for `assetDecimals: 0` properties; multiples of 0.0001, at least 0.01 tokens and $1 notional, for fractional ones |
